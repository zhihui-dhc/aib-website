...
BitcoinNG <a href="https://arxiv.org/pdf/1510.02037v2.pdf">[6]</a>, are vertical scaling solutions that remain
...
<h3 id="tendermint-bft">Tendermint-BFT</h3>
...
proven BFT algorithms developed at MIT in 1988 <a href="http://groups.csail.mit.edu/tds/papers/Lynch/jacm88.pdf">[20]</a>, the Tendermint team was the first to
...
<p><img src="https://raw.githubusercontent.com/gnuclear/atom-whitepaper/master/images/hub_and_zones.png" alt="Figure of hub and zonesacknowledgement"></p>
...
<p><img src="https://raw.githubusercontent.com/gnuclear/atom-whitepaper/master/msc/ibc_without_ack.png" alt="Figure of Zone1, Zone2, and Hub IBC withoutacknowledgement"></p>
...
<h3 id="distributed-exchange">Distributed Exchange</h3>
...
<p>A privileged zone can act as the source of a pegged token of another
...
<p>For instance, a Cosmos zone with a specific validator set, possibly the same as
...
<p>A result of this integration could be, for instance, allowing anyone with
an account at a bank on the zone to move dollars from their bank account
to other accounts on the zone, or to the hub, or to another zone entirely.<br>
...
their interoperability to the realm of exchanges.</p>
...
<h3 id="becoming-a-validator-after-genesis-day">Becoming a Validator After Genesis Day</h3>
...
<p>Some &quot;malicious&quot; behavior does not produce obviously discernable evidence on the
...
distributed in accordance with the decisions made by the governance system.</p>
...
<h2 id="governance-2">Governance</h2>
...
including most recently one created by IBM as part of their contribution to Hyperledger.</p>
...
<h5 id="cosmos-vs-ethereum-20-mauve">Cosmos vs Ethereum 2.0 Mauve</h5>
...
<p>Note this is unlike Bitcoin, where forking is a regular occurence due to
...
app Merkle hash.</p>
<p><img src="https://raw.githubusercontent.com/gnuclear/atom-whitepaper/master/msc/ibc_with_ack.png" alt="Figure of Zone1, Zone2, and Hub IBC withacknowledgement"></p>
...
<p><img src="https://raw.githubusercontent.com/gnuclear/atom-whitepaper/master/msc/ibc_with_ack_timeout.png" alt="Figure of Zone1, Zone2, and Hub IBC with acknowledgement andtimeout"></p>
...
<a href="http://en.wikipedia.org/wiki/AVL_tree">AVL algorithm</a>, and all operations are
O(log(n)).</p>

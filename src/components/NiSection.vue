<template>
  <section class="ni-section">
    <div class="ni-section-container">
      <header class="ni-ni-section-header">
        <h2 class="ni-section-title">
...
.ni-section
  ...
  &.ni-section-dark
    background mcolor linear-gradient(top, lighten(mcolor,5%), darken(mcolor,5%))
    background mcolor

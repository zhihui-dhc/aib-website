...
<div class="article-date">2016-08-31</div>
...
unleash a new era of speed, security, scalability, and usability.</p>
<p>Cosmos is a culmination of these lessons and innovations, designed to be
extended to incorporate even future innovations, to create a distributed ledger
platform suitable for generations to come.</p>
<p>One of the great tragedies of cryptocurrencies has been their failure to
...
too much of your money.</p>
<p>While mechanisms like <a href="https://en.bitcoin.it/wiki/Atomic_cross-chain_trading">atomic
swaps</a> between chains can
help link communities, they suffer from a need for mature liquidity markets and
active participants on each side (or suffer long timeouts).  The <a href="https://coinmarketcap.com/">alt-coin
ecosystem</a> is an alchemical soup of enthusiasts
...
(PoW) designs.</p>
<p><a href="https://ethereum.org/">Ethereum</a> sought to address the problem, somewhat
...
to the current state transition machine.</p>
<p>Of course, Ethereum doesn't address the problem of turning fiat currency into
...
<a href="http://www.coindesk.com/fidor-ethereum-core-banking/">institutions</a> are
...
integration with existing systems and currencies.</p>
<p>Each existing cryptocurrency supports some cultural ideal.  Bitcoin is decidedly
...
siloed from one another by great chasms of incompatibility?</p>
<p>Clearly, what we need is something more general than Ethereum - a sort of meta-Ethereum;
...
something with extreme flexibility that does not compromise security.</p>
<p>Enter Cosmos. Cosmos is a network and a framework for interoperability between
...
facilitates interoperability between some set of zones.</p>
<p>Hubs and zones are powered by the <a href="http://tendermint.com/">Tendermint</a>
<a href="https://github.com/tendermint/tendermint/wiki/Byzantine-Consensus-Algorithm">Proof-of-Stake (PoS) consensus
algorithm</a>,
using the <a href="http://tendermint.com/blog/tendermint-socket-protocol/">TMSP
interface</a> to host
...
security features of a Tendermint-powered blockchain.</p>
<p>Zones communicate with one another through a hub, primarily in the form of
assymetric transfer of some set of tokens from one zone to another.
Effectively, a hub is a blockchain with many
<a href="https://blockstream.com/sidechains.pdf">sidechains</a>, but using PoS instead of
...
a light client for all its zones.  <a href="https://github.com/tendermint/tendermint/wiki/Light-Client-Protocol">Tendermint makes this
efficient</a>
with compact light client proofs that are secure so long as the validator set is
known, which can be achieved by ensuring the light client <a href="https://blog.ethereum.org/2014/11/25/proof-stake-learned-love-weak-subjectivity/">synchronizes with
validator set changes at least as often as they are permitted to
occur</a>.</p>
<p>Many people have <a href="https://download.wpsoftware.net/bitcoin/pos.pdf">rallied against the use of
Proof-of-Stake</a>, claiming it is
impossible to secure.  Simultaneously, they acknowledge that it is nearly
trivial to secure many PoS chains using a single, secure PoW chain.  It is <a href="https://twitter.com/buchmanster/status/738550345597648896">my
own position</a> that
...
systems, and various other token-based systems in the world.</p>
<p>Cosmos reflects this position in that it makes no distinction between hubs - there
...
with it, and potentially replace it.</p>
<p>Cosmos thus introduces a new kind of market dynamic that formalizes the power
...
holding stewards of the system accountable and quality of service high.</p>
<p>Whether as testing grounds for new cryptocurrency designs, or an upgrade to
